...
import { filter } from './components/security.js';
import { rgbaToHex, calculateContrastRatio, keyboardFocusable, isDecimal } from './components/utils.js';
...
window.WebServerAI = class {
    ...
    load(){
        if(this.enabled){
            ...
            this.previewBox = this.request(this.origin+'/WebServerAI/data/settings.json?u='+this.#uniqid(),true)['previewBox'];
